...
Создаю бакет `cc-lab4-website-k06`:

(поменял название с web на webiste, не создавался)

![image](screenshots/Screenshot_14.png)

Дальше перехожу в  Properties -> Static website hosting -> Edit -> Enable

![image](screenshots/Screenshot_15.png)

Далее клонирую прикрепленное веб-приложение на свой компьютер:

![image](screenshots/Screenshot_16.png)

Затем копирую эти файлы через `AWS CLI`:

![image](screenshots/Screenshot_17.png)

Открываю URL и вижу сайт:
...
# Вывод
В ходе работы я на практике ознакомился с сервисом Amazon S3 и его основными возможностями. Создал публичный и приватный бакеты, загрузил файлы через консоль и AWS CLI, настроил доступы, включил версионирование и протестировал работу с разными версиями объектов.